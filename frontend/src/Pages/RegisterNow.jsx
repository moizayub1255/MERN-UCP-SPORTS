    ...
    <div>
      ...
      >
        <div className="text-center">
          <Row>
            <Col>
              <Image src="pgclogo.png" height="160" width={200} />
            </Col>
            <Col>
              <Image src="logo-2026.jpeg" height="120" />
            </Col>
            <Col>
              <Image src="ucplogo.png" height="120" />
            </Col>
          </Row>
          <h2 className="text-center mt-4">
            UCP GAME-ON 2025 SPORTS REGISTRATION FORM
          </h2>
          <hr />
          <Row className="m-3">
            <Col>
              <Image src="warriors.png" height="100" width={100} />
            </Col>
            <Col>
              <Image src="jaguars.png" height="100" width={100} />
            </Col>
            <Col>
              <Image src="hawks.png" height="100" width={100} />
            </Col>
            <Col>
              <Image src="gladiators.png" height="100" width={100} />
            </Col>
          </Row>
          <p className="text-center">
            Please complete this form if you would like to compete in the PGC
            GAME-ON 2025. Please note completion of this form does not guarantee
            team selection. Final teams are at the discretion of the House
            In-charge.
          </p>
        </div>
        ...
        <Form>
              ...
              <Row>
                ...
                <Col>
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setDetails({ ...details, program: e.target.value })
                    }
                  />
                </Col>
              </Row>
                ...
                <Col>
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                      {["Warriors", "Gladiators", "Hawks", "Jaguar"].map(
                        (house) => (
                          <li
                            key={house}
          ...
          <div style={{ fontSize: "0.9em" }}>
            ...
            <p>
              * Students are required to pay Rs. 3500 as Entry fee to House
              In-charge with this form.
            </p>
            <p>
              * Management will provide themed Sports Uppers/Zippers to all
              registered students as kit.
            </p>
          </div>
